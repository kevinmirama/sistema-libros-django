...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Asegura que las vistas públicas no requieran autenticación
    ],
...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS','reto-vacante.rj.r.appspot.com').split(',')
